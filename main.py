...
#insert into db
stmt = insert(data).values(dateTime=time, temperature = round(sense.get_temperature()), humidity = round(sense.get_humidity()), pressure = round(sense.get_pressure()))
...
pushMessage("Current reading at " + time, "Temperature: "+temp+nl+"Pressure: "+pressure+nl+"Humidity: "+humid)